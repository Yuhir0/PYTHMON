...
xmldoc = xml.dom.minidom.parse("./dades.xmlor n in xmldoc.getElementsByTag):
	print n.toxml()
	print n.firstChild.data
for n in xmldoc.getElementsByTagName("Nom"):
	print n.toxml()
	print n.firstChild.data
for n in xmldoc.getElementsByTagName("mon1"):
	print n.toxml()
	print n.firstChild.data
	for n in xmldoc.getElementsByTagName("mon1"):
	print n.toxml()
	print n.firstChild.data
	for n in xmldoc.getElementsByTagName("mon2"):
	print n.toxml()
	print n.firstChild.data			
